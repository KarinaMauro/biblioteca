...
<head>
    ...
    <link rel="stylesheet" href="../reserva/crud.css">
</head>
<body>
    <header>
        <div class="logo">
            ...
            <li><a href="../index.html">Início</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="../ficcao.html">Fic</a></li>
    ...
    <option value="livro1">A Rainha Vermelha</option>
    <option value="livro2">Biblioteca da Meia-Noite</option>
    <option value="livro3">As Crônicas de Nárnia</option>
    <option value="livro4">O Homem de Giz</option>
</select>
