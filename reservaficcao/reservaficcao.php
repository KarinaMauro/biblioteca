...
<head>
    ...
    <link rel="stylesheet" href="../reservaficcao/crud.css">
</head>
<body>
    <header>
        <div class="logo">
    ...
    <option value="livro1">O Ladrão de Raios</option>
    <option value="livro2">Corte de Espinhos e Rosas</option>
    ...
    <?php
require_once '../reservaficcao/db.php';
...
if (isset($_POST['submit'])) {
    ...
    $livroOptions = [
        'livro1' => 'O Ladrão de Raios',
        'livro2' => 'Corte de Espinhos e Rosas',
